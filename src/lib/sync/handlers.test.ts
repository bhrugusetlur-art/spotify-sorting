...
const success: SyncResult = {
  ...
  playlists: [{ mood: "chill", name: "Mood Sorter — Chill", url: "https://open.spotify.com/playlist/playlist-1" }],
};
...
function failed(code: "AUTH_REQUIRED" | "SPOTIFY_RATE_LIMITED" | "SPOTIFY_UNAVAILABLE"): SyncResult {
  return {
    ...success,
    run: {
      ...success.run,
